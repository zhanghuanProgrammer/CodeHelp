...
/**获取某个长度的随机的字符串*/
+ (NSString *)getRandomStringWithLenth:(NSInteger)Lenth{
    
    NSMutableString *idText=[NSMutableString string];
    while (idText.length<Lenth) {
...
+ (NSArray<NSValue *> *)getAllTargetRangeInMainString:(NSString *)mainString withRegex:(NSRegularExpression*)regex{
